...
const Profile = () => {
  ...
  return (
    <div className='flex flex-col items-center mb-5'>
      <div className='pt-10 w-full lg:w-[60%]'></div>
          ...
          <div className='lg:flex gap-32'>
            <div className='space-y-7'>
              <div className='flex'>
                ...
                <p className='text-gray-500'>gjaytech@gmail.com</p>
              </div>

              <div className='flex'>
                <p className='w-[9rem]'>Full Name : </p>
                <p className='text-gray-500'>code with jay</p>
              </div>
            ...
            <div className='space-y-7'>
              <div className='flex'>
                ...
                <p className='text-gray-500'>Rivers State</p>
              </div>
              ...
              <div className='flex'>
                ...
                <p className='text-gray-500'>564440</p>
              </div>
