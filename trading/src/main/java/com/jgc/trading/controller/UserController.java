...
import com.jgc.trading.request.ForgotPasswordTokenRequest;
...
import com.jgc.trading.request.ResetPasswordRequest;
import com.jgc.trading.response.ApiResponse;
import com.jgc.trading.response.AuthResponse;
import com.jgc.trading.service.EmailService;
import com.jgc.trading.service.ForgotPasswordService;
import com.jgc.trading.service.UserService;
import com.jgc.trading.service.VerificationCodeService;
    ...
    public ResponseEntity<AuthResponse> sendForgotPasswordOtp(
        ...
        if(token == null){
            token = forgotPasswordService.createToken(user,
                    id,otp,req.getVerificationType(),req.getSendTo());
        }
